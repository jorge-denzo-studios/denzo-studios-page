        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end">
          <div className="max-w-xl">
            ...
            >
              <a
                href="tel:8332002676"
                className="group/btn relative inline-flex items-center gap-4 px-8 py-4 md:px-10 md:py-5 rounded-full font-bold text-lg overflow-hidden transition-all duration-700 hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_40px_rgba(191,90,242,0.15)] hover:shadow-[0_0_50px_rgba(191,90,242,0.35)] bg-[#1c1c1e] dark:bg-black/40 backdrop-blur-2xl border border-white/5"
              >
                ...
                <span className="relative z-10 px-4 py-1.5 rounded-full bg-[#BF5AF2]/15 text-[#BF5AF2] text-sm font-semibold border border-[#BF5AF2]/30 flex items-center gap-2">
