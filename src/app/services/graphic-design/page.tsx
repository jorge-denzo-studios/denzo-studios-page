        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <a
                href="tel:8332002676"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#FF2D9B] text-white font-bold text-sm uppercase tracking-widest hover:bg-[#d42485] transition-all hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_30px_rgba(255,45,155,0.4)]"
              >
